			...
			<div class="row">
				...
				<aside class="col-lg-3 order-lg-first">
					<form id="FilterForm" method="post" action="">
						{{ csrf_field() }}
						<input type="hidden" name="old_category" id="get_old_category_id" value="{{ !empty($getCategory) ? $getCategory->id : '' }}">
						<input type="hidden" name="old_sub_category" id="get_old_sub_category_id" value="{{ !empty($getSubCategory) ? $getSubCategory->id : '' }}">
						<input type="hidden" name="sub_category" id="get_sub_category_id">
							...
							<div class="collapse show" id="widget-3">
								<div class="widget-body">
									<div class="filter-colors">
										...
										<a href="javascript:;" id="{{ $f_color->id }}" value="{{ $f_color->id }}" data-val="0" class="ChangeColor" style="background: {{ $f_color->code }}; border: solid 1px #999;"><span class="sr-only">{{$f_color->name}}</span></a>
										@endforeach
