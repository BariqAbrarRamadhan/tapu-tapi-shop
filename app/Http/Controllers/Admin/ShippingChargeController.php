...
class ShippingChargeController extends Controller
{
    ...
    {   
        ...
        return redirect('admin/shipping_charge/list')->with('success', 'Shipping Charge create successfully!');
    }
    ...
    public function update($id, Request $request)
    {
        ...
        return redirect('admin/shipping_charge/list')->with('success', 'Shipping Charge update successfully!');
    }

    public function delete($id)
    {
        $shippingcharge = ShippingChargeModel::getSingle($id);
        $shippingcharge->is_deleted = 1;
        $shippingcharge->save();

        return redirect()->back()->with('success', 'Shipping Charge delete successfully!');
    }
}
